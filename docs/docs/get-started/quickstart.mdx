...
This quickstart installs OpenRAG with [`uvx`](https://docs.astral.sh/uv/guides/tools/#running-tools) which automatically installs OpenRAG's dependencies as needed, including Docker or Podman.
...
10. Click through the onboarding chat for a brief introduction to OpenRAG, or click <Icon name="ArrowRight" aria-hidden="true"/> **Skip overview**.
