...
10. Test the GPU with Podman, and make sure `nvidia-smi` prints your GPU information instead of an error:
...
12. Start the TUI, and then start OpenRAG with GPU mode enabled.
